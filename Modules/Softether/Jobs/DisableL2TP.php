...
class DisableL2TP implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $ipsecSet = sprintf('docker exec %s vpncmd localhost:5555 /SERVER /PASSWORD:%s /CSV /CMD:IpsecEnable /L2TP:no /PSK:%s /DEFAULTHUB:%s  /ETHERIP:no /L2TPRAW:no',
            self::CONTAINER_NAME,
