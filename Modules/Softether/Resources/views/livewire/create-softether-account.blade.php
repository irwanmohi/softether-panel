                ...
                <div class="body">
                    ...
                    <div wire:loading wire:target="submit" class="waitMe" data-waitme_id="169" style="background: rgba(255, 255, 255, 0.7);">
                        <div class="waitMe_content" style="margin-top: 0px;">
                            ...
                            <div class="waitMe_text" style="color:#663AB7">CREATING ACCOUNT...</div>
                        </div>
                    </div>
...
<script charset="utf-8">
    ...
    window.addEventListener('DOMContentLoaded', function() {
        ...
        @this.on('SoftetherAccountCreated', function(account, redirectUrl) {
            swal({
                title: "Account Created!",
                text: "Your VPN Account is successfully created!",
                icon: "success",
                buttons: [false, true],
